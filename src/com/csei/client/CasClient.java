...
public class CasClient {
	...
	public static CasClient getInstance() {
		if (instance == null) {
			synchronized (CasClient.class) {
				if (instance == null) {
					instance = new CasClient(
							"http://www.cseicms.com/inspectCas/v1/");
					// instance = new
					// CasClient("http://www.cseicms.com/cas/v1/");
				}
			}
		}
		return instance;
	...
	public String doSendFile2(String ServicePath, String FilePath)
	...
	synchronized public String doSendImage(String service, String filePath,
